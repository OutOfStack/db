...
//
//	mockgen -destination=internal/network/mocks/net.go -package=network_mocks net Conn,Listener
//

// Package network_mocks is a generated GoMock package.
package network_mocks
