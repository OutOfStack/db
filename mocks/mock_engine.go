...
// Source: github.com/OutOfStack/db (interfaces: Engine)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_engine.go -package=mocks . Engine
//
...
func (m *MockEngine) Del(ctx context.Context, key string) error {
	m.ctrl.T.Helper()
